            ...
            <div className="bg-gray-50 border-b border-gray-200 p-4">
              ...
              <div className="flex items-center gap-2 border-t border-gray-200 pt-3 mt-3">
                <input
                  ...
                  placeholder="Custom Size (e.g. 33, XL)"
                  className="text-xs border border-gray-300 rounded px-2 py-1.5 focus:ring-1 focus:ring-blue-500 outline-none"
                  onKeyDown={(e) => e.key === 'Enter' && addCustomSize(group.id)}
                />
                <button
                  onClick={() => addCustomSize(group.id)}
                  className="flex items-center gap-1 px-3 py-1.5 bg-blue-600 text-white text-xs font-bold rounded hover:bg-blue-700 transition-colors"
                >
                  <Plus size={14} /> Add
                </button>
              </div>
