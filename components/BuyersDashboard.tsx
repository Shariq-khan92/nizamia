...
interface BuyersDashboardProps {
  ...
  agencies: BuyingAgency[];
  onAddAgency: (agency: BuyingAgency) => void;
  onDeleteAgency: (id: string) => void;
}

export const BuyersDashboard: React.FC<BuyersDashboardProps> = ({ buyers, onAddBuyer, onDeleteBuyer, agencies, onAddAgency, onDeleteAgency }) => {
